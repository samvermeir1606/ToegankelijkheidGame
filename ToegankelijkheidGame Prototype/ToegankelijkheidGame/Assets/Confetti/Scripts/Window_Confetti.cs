...
public class Window_Confetti : MonoBehaviour {
    ...
    public float ConfettiMinSpeed;
    public float ConfettiMaxSpeed;
    ...
    private void SpawnConfetti() {
        ...
        Color color = ConfettiColors[Random.Range(0, ConfettiColors.Count)];
        Confetti confetti = new Confetti(pfConfetti, transform, anchoredPosition, color, -height / 2f,ConfettiMinSpeed, ConfettiMaxSpeed);
    ...
    private class Confetti {
        ...
        public Confetti(Transform prefab, Transform container, Vector2 anchoredPosition, Color color, float minimumY, float minspeed,float maxspeed) {
            ...
            moveAmount = new Vector2(0, Random.Range(minspeed, maxspeed));
